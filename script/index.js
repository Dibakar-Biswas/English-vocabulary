...
const displayWordDetail = (word) => {
    ...
    <div>
            ...
            <div>
                <h2 class="font-bold">সমার্থক শব্দগুলো</h2>
...
// }
    ...
    words.forEach(word => {
        ...
        <div class="bg-white rounded-xl shadow-sm text-center py-10 px-5 space-y-4">
            ...
            <div class="font-semibold text-2xl font-bangla">${word.meaning ? word.meaning : "অর্থ পাওয়া যায়নি"} / ${word.pronunciation ? word.pronunciation:"উচ্চারণ পাওয়া যায়নি"}</div>
...
const displayLessons = (lessons) => {
    // 1. get into the container and empty
